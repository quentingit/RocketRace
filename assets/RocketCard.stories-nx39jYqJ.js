import{R as r}from"./index-B-SYruCi.js";import{I as w}from"./image-BsBPtjSv.js";import{c as q}from"./clsx-B-dksMZM.js";import{p as f}from"./prefix-Bnxz6LC4.js";import"./use-merged-ref-B6IZN_wr.js";import"./jsx-runtime-BEh3FTX5.js";import"./index-C-aVi5AG.js";const y=({rocket:e,isSelected:t,launching:s,onToggleSelection:v})=>{const R=q("relative border-4 rounded-lg p-4 shadow-lg text-center bg-black bg-opacity-75 text-white cursor-pointer transition-transform transform hover:scale-105",t?"neon-border-green":"neon-border-blue",s&&t&&"animate-pulse",t?"selected-rocket":"pulsating selected-rocket",s&&t&&"animate-rocket-launch");return r.createElement("div",{key:e.id,onClick:()=>v(e),className:R},r.createElement(w,{src:e.image,alt:e.name,width:150,height:150,className:"object-contain mx-auto rounded-md neon-rocket-green animate-floating"}),r.createElement("h2",{className:"mt-4 font-pixel text-neon-yellow"},e.name),r.createElement("p",{className:"text-sm font-pixel text-neon-gray"},e.description))};y.__docgenInfo={description:"",methods:[],displayName:"RocketCard",props:{rocket:{required:!0,tsType:{name:"intersection",raw:"Rocket & RocketProgress",elements:[{name:"signature",type:"object",raw:`{
  ...
  id: Scalars['ID']['output'];
  progress: Scalars['Int']['output'];
}`,signature:{properties:[{key:"__typename",value:{name:"literal",value:"'RocketProgress'",required:!1}},{key:"exploded",value:{name:"signature['output']",raw:"Scalars['Boolean']['output']",required:!0}},{key:"id",value:{name:"signature['output']",raw:"Scalars['ID']['output']",required:!0}},{key:"progress",value:{name:"signature['output']",raw:"Scalars['Int']['output']",required:!0}}]}}]},name:"rocket"}],return:{name:"void"}}},description:""}}};const C={title:"Components/RocketCard",component:y,args:{isSelected:!1,launching:!1,onToggleSelection:()=>alert("Toggled!")},argTypes:{onToggleSelection:{action:"clicked"}}},u={id:"1",name:"Falcon 9",description:"Reusable rocket by SpaceX.",image:`${f}/rocket.png`},a={args:{rocket:u}},n={args:{rocket:u,isSelected:!0}},o={args:{rocket:u,isSelected:!0,launching:!0}};var i,c,l;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    rocket: mockRocket as RocketInteraction
  }
}`,...(l=(c=a.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var p,m,d;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    rocket: mockRocket as RocketInteraction,
    isSelected: true
  }
...
}`,...(S=(k=o.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};const P=["Default","Selected","Launching"];export{a as Default,o as Launching,n as Selected,P as __namedExportsOrder,C as default};
