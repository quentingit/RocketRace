import{R as r}from"./index-B-SYruCi.js";import{L as y}from"./link-yc7BxYAG.js";import{N as x}from"./nextImageMock-C6ws-YJd.js";import"./jsx-runtime-BEh3FTX5.js";const f=(e,t,s)=>e?e===t.id?t.name:s.name:"Course en cours",d=({race:e})=>{const t=[e.rocket1,e.rocket2],s=f(e.winner,e.rocket1,e.rocket2),k=t.map(a=>r.createElement("div",{key:a.id,className:"flex flex-col items-center"},r.createElement(x,{src:a.image,alt:a.name,width:100,height:100,className:"rounded-md"}),r.createElement("p",{className:"mt-2 text-neon-yellow"},a.name)));return r.createElement("li",{key:e.id,className:"border-b border-gray-700 pb-4 hover:bg-gray-800 transition"},r.createElement(y,{href:`/race/${e.id}`,rel:"noopener noreferrer",className:"block p-4"},r.createElement("p",{className:"text-xl mb-2"},"Course ID : ",e.id),r.createElement("div",{className:"flex mt-4"},r.createElement("div",{className:"flex space-x-10"},k),r.createElement("div",{className:"flex items-center ml-10 border-l-2 border-neon-green pl-6"},r.createElement("span",{className:"text-2xl font-bold text-neon-blue mr-2"},"Gagnant :"),r.createElement("span",{className:"text-2xl font-bold text-neon-green"},s)))))};d.__docgenInfo={description:"",methods:[],displayName:"RaceItem",props:{race:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ...
  id: Scalars['ID']['output'];
  progress: Scalars['Int']['output'];
}`,signature:{properties:[{key:"__typename",value:{name:"literal",value:"'RocketProgress'",required:!1}},{key:"exploded",value:{name:"signature['output']",raw:"Scalars['Boolean']['output']",required:!0}},{key:"id",value:{name:"signature['output']",raw:"Scalars['ID']['output']",required:!0}},{key:"progress",value:{name:"signature['output']",raw:"Scalars['Int']['output']",required:!0}}]},required:!0}},{key:"winner",value:{name:"union",raw:"T | null",elements:[{name:"signature['output']",raw:"Scalars['ID']['output']"},{name:"null"}],required:!1}}]}},description:""}}};const b={title:"Components/RaceItem",component:d,tags:["autodocs"]},v={id:"rocket-1",name:"Falcon 9",image:"/rocket.png",description:""},w={id:"rocket-2",name:"Starship",image:"/rocket.png",description:""},g={id:"race-123",rocket1:v,rocket2:w,winner:"rocket-1"},n={args:{race:g}},o={args:{race:{...g,winner:null}}};var u,c,l;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    race: mockRace
  }
...
}`,...(p=(m=o.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};const _=["Default","NoWinner"];export{n as Default,o as NoWinner,_ as __namedExportsOrder,b as default};
